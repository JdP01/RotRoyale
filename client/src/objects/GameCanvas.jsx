    ...
    socket.onmatchdata = (matchData) => {
      ...
      try {
        ...
        if (typeof matchData.data === 'string') {
          ...
          console.warn("Unexpected match data format:", matchData);
          return;
        }
        ...
        if (gameUpdate.type === 'player_update' && gameUpdate.playerId !== userSession.account.user.id) {
          console.log("Updating other player data for:", gameUpdate.playerId);
          console.log("Player position:", gameUpdate.position);
          ...
          setOtherPlayersData(prev => {
            ...
            console.log("Updated other players data:", updated);
            return updated;
          });
        }
      } catch (error) {
